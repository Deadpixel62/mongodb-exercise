...
function Exo() {
    ...
    useEffect(() =>
      axios
        .get("http://localhost:4000/students/allStudents")
    ...
    const handleSubmit =(e) => {
        e.preventDefault();
        axios.post("http://localhost:4000/exos/addExo" , exo)
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      />
      <input type="number" value={exo.duration} placeholder='Enter duration' required   onChange={(e) => setExo({
          ...exo,
